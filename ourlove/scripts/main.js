...
var main = new Vue({
	...
	data: {
		...
		importentDays: [
			...
			{name: '冬至节', date: '2016/12/21'},
			{name: '平安夜', date: '2016/12/24'},
			{name: '圣诞节', date: '2016/12/25'},
			{name: '跨年夜', date: '2016/12/31'},
			{name: '元旦节', date: '2017/01/01'},
			{name: '四个月纪念', date: '2017/01/03'},
			{name: '除夕夜', date: '2017/01/27'},
			{name: '大年初一', date: '2017/01/28'},
			{name: '五个月纪念', date: '2017/02/03'},
			{name: '元宵节', date: '2017/02/11'},
			{name: '情人节', date: '2017/02/14'},
			{name: '龙抬头', date: '2017/02/27'}
		]
	},
	computed: {
		totalTime: function(){
